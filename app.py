...
[필수] 1. 수식 $ $ 필수. 분수는 $\\frac{{a}}{{b}}$ 사용.
2. 과목/단원 등의 메타데이터 출력 절대 금지.
...
async def run_orchestrator(choice_sub, num, score_val=None):
    from __main__ import get_exam_blueprint # 블루프린트 참조
