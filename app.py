    ...
    <head>
        ...
        <style>
            ...
            * {{ 
            ...
            .question-box {{ 
                position: relative; line-height: 1.85; font-size: 11pt; 
                padding-left: 38px; margin-bottom: 45px; text-align: justify; 
            }}
            ...
            .q-num {{ 
                ...
                text-align: center; line-height: 23px; font-size: 12pt; background: #fff;
            }}
